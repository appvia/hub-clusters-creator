...
module HubClustersCreator
  ...
  module Errors
    # InfrastructureError defines an error occurred creating or configuring
    # the cluster
    ...
    class ConfigurationError < StandardError
      def initialize(msg = 'invalid configuration')
        super(msg)
      end
    end

    # InitializerError is thrown when we've encountered an error attempting
